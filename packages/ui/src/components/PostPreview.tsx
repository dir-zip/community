    ...
    <div className="max-h-96 overflow-hidden px-6 py-4 bg-primary-800 rounded border relative">
        ...
        <div className="flex justify-between items-center pt-4">
          ...
          <div className="bg-primary-700 px-2 py-2 rounded flex items-center space-x-8 transition-all duration-500 ease-in-out">
            <PenSquare className='text-link w-4 h-4' onClick={toggleShowEdit}/>
            
            {showEdit ? <div className="flex items-center space-x-4"><Hash className='text-link w-4 h-4' /> <LucideSquareStack className='text-link w-4 h-4' /></div> : null}
          </div>
        </div>
    </div>
  )
